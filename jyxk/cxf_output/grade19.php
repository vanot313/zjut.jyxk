...
/****修改点****/
$db[0]=array("19级19学年人文讲座", "19级19学年人文比赛", "19级19学年科技讲座", "19级19学年科技比赛");
/****修改点****/

/****修改点****/
$result_stu =  $mysql->query("SELECT * FROM 19级19学年科技讲座");
/****修改点****/
...
while ($row_stu = $result_stu->fetch_array()){
	...
	/****修改点****/
    $people[$line][0][4] = $people[$line][0][3];
	/****修改点****/
...
//    ->setCellValue('M1', '15年人文讲')
//    ->setCellValue('N1', '15年人文比')
//    ->setCellValue('O1', '15年科技将')
//    ->setCellValue('P1', '15年科技比');
////    ->setCellValue('Q1', '14年人文讲')
////    ->setCellValue('R1', '14年人文比')
////    ->setCellValue('S1', '14年科技将')
////    ->setCellValue('T1', '14年科技比')
...
//        ->setCellValue('M' . $i, $people[$i][5][0])
//        ->setCellValue('N' . $i, $people[$i][6][0])
//        ->setCellValue('O' . $i, $people[$i][7][0])
//        ->setCellValue('P' . $i, $people[$i][8][0]);
...
$objPHPExcel->getActiveSheet()->setTitle('19');
$objPHPExcel->setActiveSheetIndex(0);
header('Content-Type: application/vnd.ms-excel'); //excel头参数

/****修改点****/
header('Content-Disposition: attachment;filename="grade_19_With_1years.xls"');
/****修改点****/
