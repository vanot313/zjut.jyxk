...
/****修改点****/
$db[0]=array("18级19学年人文讲座", "18级19学年人文比赛", "18级19学年科技讲座", "18级19学年科技比赛");
$db[1]=array("18级18学年人文讲座", "18级18学年人文比赛", "18级18学年科技讲座", "18级18学年科技比赛");
/****修改点****/

/****修改点****/
$result_stu =  $mysql->query("SELECT * FROM 18级19学年科技讲座");
/****修改点****/
...
$objPHPExcel->getActiveSheet()->setTitle('18');
$objPHPExcel->setActiveSheetIndex(0);
header('Content-Type: application/vnd.ms-excel'); //excel头参数

/****修改点****/
header('Content-Disposition: attachment;filename="grade_18_With_2years.xls"');
/****修改点****/
