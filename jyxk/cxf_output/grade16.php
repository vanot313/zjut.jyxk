...
/****修改点****/
$db[0]=array("16级19学年人文讲座", "16级19学年人文比赛", "16级19学年科技讲座", "16级19学年科技比赛");
$db[1]=array("16级18学年人文讲座", "16级18学年人文比赛", "16级18学年科技讲座", "16级18学年科技比赛");
$db[2]=array("16级17学年人文讲座", "16级17学年人文比赛", "16级17学年科技讲座", "16级17学年科技比赛");
$db[3]=array("16级16学年人文讲座", "16级16学年人文比赛", "16级16学年科技讲座", "16级16学年科技比赛");
/****修改点****/

/****修改点****/
$result_stu =  $mysql->query("SELECT * FROM 16级19学年科技讲座");
/****修改点****/
...
while ($row_stu = $result_stu->fetch_array()){
    ...
    /****修改点****/
    $people[$line][0][7] = $people[$line][0][3]+$people[$line][0][4]+$people[$line][0][5]+$people[$line][0][6];
	/****修改点****/
...
$objPHPExcel->setActiveSheetIndex(0)
    ...
    ->setCellValue('U1', '16年人文讲座')
    ->setCellValue('V1', '16年人文比赛')
    ->setCellValue('W1', '16年科技讲座')
    ->setCellValue('X1', '16年科技比赛');
	/****修改点****/
;
...
for($i=1;$i<=$line;$i++) {
    ...
    $objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('G' . $l, $people[$i][0][6])
        ->setCellValue('H' . $l, $people[$i][0][7])
		/****修改点****/
        ...
        ->setCellValue('Q' . $l, $people[$i][9][0])
        ->setCellValue('R' . $l, $people[$i][10][0])
        ->setCellValue('S' . $l, $people[$i][11][0])
        ->setCellValue('T' . $l, $people[$i][12][0])
        ->setCellValue('U' . $l, $people[$i][13][0])
        ->setCellValue('V' . $l, $people[$i][14][0])
        ->setCellValue('W' . $l, $people[$i][15][0])
        ->setCellValue('X' . $l, $people[$i][16][0]);
}
$objPHPExcel->getActiveSheet()->setTitle('16');
$objPHPExcel->setActiveSheetIndex(0);
header('Content-Type: application/vnd.ms-excel'); //excel头参数

/****修改点****/
header('Content-Disposition: attachment;filename="grade_16_With_4years.xls"');
/****修改点****/
